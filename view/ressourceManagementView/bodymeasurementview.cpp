...
BodyMeasurementView::BodyMeasurementView(QWidget *parent) : SimpleNavigateableWidget(tr("Body Measurements"), parent),
    vcHeadNeck(new ValueControl()),
    vcThighLength(new ValueControl()),
    vcTibialHeight(new ValueControl()),
    vcFootLength(new ValueControl()),
    vcShoulderWidth(new ValueControl()),
    vcShoulderBiacromial(new ValueControl()),
    vcShoulderBideltoid(new ValueControl()),
    vcUpperArmLength(new ValueControl()),
    vcForearmLength(new ValueControl()),
    vcHandLength(new ValueControl()),
    vcTorsoHeight(new ValueControl()),
