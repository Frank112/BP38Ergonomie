...
signals:
    /**
     * @brief saveComment A signal that can be emitted to signal that a comment with the given <i>values</i> should be saved .
...
public slots:
    /**
     * @brief setComment Sets the comment specified in <i>values</i> to be displayed.
     * @param values A hashmap of values with each the column name and the corresponding value to this column.
     */
