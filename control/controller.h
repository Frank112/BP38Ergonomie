...
/**
 * @brief The Controller class provides functionality to handle
 *
 * The Controller is the central element for
 *
 * <b>Note:</b>
 */
...
public:
    /**
     * @brief Controller Constructs
     * @param parent The <i>parent</i> of
     * @param app
     */
    ...
    /**
     * @brief initialize All by default availabe data is being initialized
     */
    void initialize();
