...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_StandardPaths_t, stringdata) + ofs \
...
const QMetaObject StandardPaths::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_StandardPaths.data,
      qt_meta_data_StandardPaths,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StandardPaths::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StandardPaths.stringdata))
        return static_cast<void*>(const_cast< StandardPaths*>(this));
